  ...
  return (
    <section className="relative overflow-hidden bg-white px-5 py-14 sm:px-8 md:py-20 lg:px-[6vw]">
      <div className="mx-auto w-full max-w-[1900px]">
        ...
        <div
          className="-mx-5 mt-10 cursor-grab overflow-x-auto px-5 pb-3 active:cursor-grabbing [scrollbar-width:none] sm:-mx-8 sm:px-8 lg:-mx-[6vw] lg:mt-14 lg:px-[6vw] [&::-webkit-scrollbar]:hidden"
        ...
        >
          <div
            ...
            className={`staff-growth-carousel-track flex w-max snap-x snap-mandatory gap-4 ${
            ...
            {[0, 1].map((groupIndex) => (
              ...
              >
                {growthOutcomes.map((outcome, index) => {
                  ...
                  return (
                    <article
                      className="group relative flex h-[420px] w-[82vw] max-w-[460px] shrink-0 snap-start flex-col overflow-hidden bg-[#003466] p-6 text-white sm:h-[500px] sm:w-[430px] lg:w-[470px]"
                      key={`${outcome.title}-${groupIndex}`}
                    >
                      <div
                        aria-hidden="true"
