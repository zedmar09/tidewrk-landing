...
export function TypingHeadline({ text }: TypingHeadlineProps) {
  ...
  return (
    <h1
      aria-label={text}
      className="mx-auto max-w-[15ch] text-balance text-center text-[clamp(2.75rem,5.9vw,5.4rem)] font-semibold leading-[1.04] tracking-normal text-[#111217] sm:max-w-[18ch]"
    >
